...
set -e
#
# .NET SDK Installation Script for Debian/Ubuntu Systems
# 
# This script installs the .NET SDK 9.0 from the official .NET PPA repository.
# It automatically detects the system and configures the appropriate repository.
#
# Usage: sudo ./02-dotnet.sh
#
...
# Function to confirm the installed .NET version
function this::confirm_version {
   echo "ℹ️ $(dotnet --list-sdks)"
}

# List of APT packages to install
APT_PACKAGES=(dotnet-sdk-9.0)

# PPA repository from which packages will be installed
PPA_REPO="dotnet/backports"
